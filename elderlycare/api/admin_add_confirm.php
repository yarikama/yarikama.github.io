...
if (isset($_POST['member_submit'])) {
    ...
    $member_type = 2; // Set default member type here
    ...
    if ($member_password == $member_pass_confirm) {
        ...
        if ($result->num_rows > 0) {
            $_SESSION['error_message'] = "已經有員工帳號了，註冊失敗";
...
header("Location: admin_add.php"); // Redirect back to the register page in case of error
exit;
?>
