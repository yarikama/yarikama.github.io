	...
	<div class="col-lg-8 col-md-6 col-sm-10 col-xs-12">
		<div class="card rounded-0 shadow">
			<div class="card-header">
				<div class="card-title text-center h4 fw-bolder">會員註冊</div>
			</div>
			<div class="card-body">
				<div class="container-fluid">
					...
					?>
					<form class="form-horizontal" method="post" action="member_register_confirm.php">
                        <div class="mb-3">
                            <label for="member_email" class="control-label ">會員Email</label>
                        ...
                        <div class="mb-3">
                            <label for="member_pass_confirm" class="control-label ">確認會員密碼</label>
