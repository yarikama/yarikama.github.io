...
const projectsData = [
    {
        ...
        gitUrl: 'https://github.com/yarikama/Elderly-Care-Map-Website',
        previewUrl: '/'
    },{
        id: 2,
        ...
        gitUrl: 'https://github.com/yarikama/Chat_Bar',
        previewUrl: '/'
    },{
        id: 3,
        title: '書店網站',
        ...
        description: '運用 Python 達成貝式優化以及基因演算法來解決零工式生產排程，並且製作能在 Flexsim 上運行的自動建模腳本，來達到 Cross-Verification。',
        ...
        gitUrl: 'https://github.com/yarikama/JSSP-Simulation-and-Flexsim-Model',
        previewUrl: '/'
    }
]
