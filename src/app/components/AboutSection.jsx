...
const TAB_DATA = [
    {
        ...
        content: (
            <ul className='list-disc pl-2'>
                <li>資工系：資料結構與物件導向、演算法概論、網路程式設計概論、網路科學與架構、資料庫系統概論、計算機系統管理、計算機組織、作業系統、基礎程式設計</li>
                <li>工工系：計算機概論、程式設計、作業研究(一)、作業研究(二)、模擬學、基因演算法與管理實務</li>
                <li>通識課：數學應用軟體、Python基礎程式設計</li>
            </ul>
        )
    }
]
        ...
        <div className='md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16'>
            ...
            <div className='mt-4 md:mt-0 text-left flex flex-col h-full'> 
                ...
                <p className='text-base lg:text-lg'>
                    國立陽明交通大學工工系大四生，輔系資工系。
                    平均GPA 4.05/4.30, Last 60 GPA 4.15/4.30。
                    曾擔任系學會會長、管院學生代表、三次書卷獎。
                </p>
